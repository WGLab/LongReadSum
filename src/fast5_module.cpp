...
int generateQCForFAST5(Input_Para &_input_data, Output_FAST5 &output_data)
{
    ...
    read_details_file = _input_data.output_folder + "/" + _input_data.sample_name + "_readqc.fast5.txt";
    read_summary_file = _input_data.output_folder + "/" + _input_data.sample_name + "_summary.fast5.json";
