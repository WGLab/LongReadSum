...
def generate_bs( output_statistics, para_dict ):
   ...
   table_str += int_str_for_format.format("#Total Reads", \
                 ...
                 output_statistics.long_read_info.long_read_info.total_num_reads);
   table_str += int_str_for_format.format("#Total Bases", \
                 ...
                 output_statistics.long_read_info.long_read_info.total_num_bases);
   table_str += int_str_for_format.format("Longest Read Length", \
                 ...
                 output_statistics.long_read_info.long_read_info.longest_read_length);
   table_str += int_str_for_format.format("N50", \
                 ...
                 output_statistics.long_read_info.long_read_info.n50_read_length);
   table_str += double_str_for_format.format("Mean Read Length", \
                 ...
                 output_statistics.long_read_info.long_read_info.mean_read_length);
   table_str += int_str_for_format.format("Median Read Length", \
                 ...
                 output_statistics.long_read_info.long_read_info.median_read_length);
   table_str += "\n</tbody>\n</table>"
...
def plot( output_statistics, para_dict ):
    ...
    plot_read_length_stats([output_statistics.long_read_info.long_read_info, output_statistics.passed_long_read_info.long_read_info, output_statistics.failed_long_read_info.long_read_info], get_image_path('read_length_st'), subtitles=['All Reads', 'Passed Reads', 'Failed Reads'])
    
    plot_base_counts([output_statistics.long_read_info.long_read_info, output_statistics.passed_long_read_info.long_read_info, output_statistics.failed_long_read_info.long_read_info], get_image_path('base_st'), subtitles=['All Reads', 'Passed Reads', 'Failed Reads'])
    
    plot_basic_info([output_statistics.long_read_info.long_read_info, output_statistics.passed_long_read_info.long_read_info, output_statistics.failed_long_read_info.long_read_info], get_image_path('basic_info'), categories=['All Reads', 'Passed Reads', 'Failed Reads'])
    
    histogram(output_statistics.long_read_info.long_read_info, get_image_path('read_length_hist'))
